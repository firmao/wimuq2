...
require a recent version of Jena [1]. Adjust the shell script

                       ./bin/squin.sh

to set the shell variable JENA_LIBS to the 'lib' directory that you find when
you unzip the Jena package.
...
of the Jena ARQ [1] query execution framework for RDF data:
...
recent version of Jena [1] in your Java CLASSPATH, as well as the SQUIN JAR
